<div class="checklistPop pop-over is-shown" style="display: none" id="checklist-pop">
    <div class="no-back">
        <div class="pop-over-header js-pop-over-header">
            ...
            <a href="#" class="pop-over-header-close-btn icon-sm icon-close" onclick="dashboard.closePopover($('#checklist-pop'))">X</a>
        </div>
        <div>
            <div class="pop-over-content js-pop-over-content u-fancy-scrollbar js-tab-parent" style="max-height: 300px;">
                <div>
                    <div>
                        ...
                        <input class="primary wide confirm js-add-checklist button-block" type="button" value="Ajouter"  onclick="dashboard.addChecklistName()">
                    </div>
                </div>
            </div>
        </div>
